...
lgrmar1.out <- R2OpenBUGS::bugs(data = data, inits = NULL,
                                 parameters.to.save = monitor,
                                 model.file = file.path(getwd(), "lgrmar1.txt"),
                                 n.iter = n.sim, n.thin = n.thin, n.burnin = n.burn,
                                 OpenBUGS.pgm = obd,  working.directory = getwd(),
                                 debug = FALSE,
                                 codaPkg = FALSE)

lgrmar1.out <- R2WinBUGS::bugs(data = data, inits = NULL,
                                 parameters.to.save = monitor,
                                 model.file = file.path(getwd(), "lgrmar1.txt"),
                                 n.iter = n.sim, n.thin = n.thin, n.burnin = n.burn,
...
lgrmar1.out2 <- R2WinBUGS::bugs(data = data, inits = NULL,
                                 parameters.to.save = monitor,
                                 model.file = file.path(getwd(), "lgrmar1.txt"),
                                 n.iter = n.sim, n.thin = n.thin, n.burnin = n.burn,
                                 bugs.directory = wbd,  working.directory = getwd(),
